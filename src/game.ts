...
export default class Demo extends Phaser.Scene
{
    ...
    create ()
    {
        ...
        this.time.addEvent({
            ...
            callbackScope: this,
            callback: () => {
                const ball = this.matter.add.image(Phaser.Math.Between(0, 800), 0, 'ball');
        ...
        // const abc = this.matter.add.image(Phaser.Math.Between(0, 800), Phaser.Math.Between(0, 600), 'ball', undefined, {isStatic:true});
        // abc.setBounce(1);
